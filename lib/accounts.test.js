...
describe("Accounts actions", () => {
  describe("createAccount", () => {
    ...
    test("returns { success: false } if database connection fails", async () => {
      ...
      const { createAccount: createWithNoDBConnection } = await import("@/lib/accounts");
    ...
    test("returns { success: false } if email is in use", async () => {
      ...
      const { createAccount: createDuplicateAccount } = await import("@/lib/accounts"); 
