...
import { CONTAINS_LC, CONTAINS_NUMBER, CONTAINS_SPECIAL, CONTAINS_UC, IS_EMAIL, IS_REQUIRED, MATCHES, MAX, MIN, PRESETS, validationUtils } from "./validation";
...
describe("Validation Functions", () => {
  ...
  describe("IS_EMAIL", () => {
    ...
    test("Returns false when local address conatins whitespace (),:;<>@[\]", () => {
  ...
  describe("PRESET TESTS", () => {
    describe("PASSWORD", () => {
      test("Password passes when at least 8 chars containing a number, upper-, lower- and special", () => {
        const { isValid } = validationUtils.validateAll("P@ssword1", PRESETS.PASSWORD);
        expect(isValid).toBeTruthy();
      });
      test("Password passes when at least 8 chars containing a number, upper-, lower- and special", () => {
        const { isValid: v1 } = validationUtils.validateAll("P@ss1", PRESETS.PASSWORD);
        const { isValid: v2 } = validationUtils.validateAll("Password1", PRESETS.PASSWORD);
        const { isValid: v3 } = validationUtils.validateAll("P@ssword", PRESETS.PASSWORD);
        const { isValid: v4 } = validationUtils.validateAll("p@ssword1", PRESETS.PASSWORD);
        const { isValid: v5 } = validationUtils.validateAll("P@SSWORD1", PRESETS.PASSWORD);
        expect(v1).toBeFalsy();
        expect(v2).toBeFalsy();
        expect(v3).toBeFalsy();
        expect(v4).toBeFalsy();
    ...
    describe("PASSWORD_MATCH", () => {
      test("Password passes when at least 8 chars containing a number, upper-, lower- and special", () => {
        const { isValid } = validationUtils.validateAll("P@ssword2", PRESETS.PASSWORD_CONFIRM("P@ssword2"));
        expect(isValid).toBeTruthy();
      });
      test("Password passes when at least 8 chars containing a number, upper-, lower- and special", () => {
        const { isValid: v1 } = validationUtils.validateAll("P@ss1", PRESETS.PASSWORD_CONFIRM("P@ssword2"));
        const { isValid: v2 } = validationUtils.validateAll("Password1", PRESETS.PASSWORD_CONFIRM("P@ssword2"));
        const { isValid: v3 } = validationUtils.validateAll("P@ssword", PRESETS.PASSWORD_CONFIRM("P@ssword2"));
        const { isValid: v4 } = validationUtils.validateAll("p@ssword1", PRESETS.PASSWORD_CONFIRM("P@ssword2"));
        const { isValid: v5 } = validationUtils.validateAll("P@SSWORD1", PRESETS.PASSWORD_CONFIRM("P@ssword2"));
        const { isValid: v6 } = validationUtils.validateAll("P@ssword1", PRESETS.PASSWORD_CONFIRM("P@ssword2"));
        expect(v1).toBeFalsy();
        expect(v2).toBeFalsy();
        expect(v3).toBeFalsy();
        expect(v4).toBeFalsy();
